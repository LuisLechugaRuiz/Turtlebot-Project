...
echo_and_run cd "/home/luis/Turtlebot-Project/src/kobuki/kobuki_testsuite"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/luis/Turtlebot-Project/src/kobuki/kobuki_testsuite/setup.py" \
    build --build-base "/home/luis/Turtlebot-Project/build/kobuki/kobuki_testsuite" \
    install \
    --root="${DESTDIR-/}" \
