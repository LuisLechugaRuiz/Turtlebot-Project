...
echo_and_run cd "/home/luis/Turtlebot-Project/src/kobuki_desktop/kobuki_dashboard"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/luis/Turtlebot-Project/src/kobuki_desktop/kobuki_dashboard/setup.py" \
    build --build-base "/home/luis/Turtlebot-Project/build/kobuki_desktop/kobuki_dashboard" \
    install \
    --root="${DESTDIR-/}" \
