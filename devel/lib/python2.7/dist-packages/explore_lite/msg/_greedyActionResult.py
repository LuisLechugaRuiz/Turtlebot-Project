...
"""autogenerated by genpy from explore_lite/greedyActionResult.msg. Do not edit."""
import sys
...
class greedyActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "explore_lite/greedyActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','explore_lite/greedyResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(greedyActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = explore_lite.msg.greedyResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = explore_lite.msg.greedyResult()
