...
if("TRUE" STREQUAL "TRUE")
  set(decision_maker_SOURCE_PREFIX /home/luis/Turtlebot-Project/src/decision_maker)
  set(decision_maker_DEVEL_PREFIX /home/luis/Turtlebot-Project/devel)
  ...
  set(decision_maker_INSTALL_PREFIX /home/luis/Turtlebot-Project/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'luis <luislechugaruiz@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'decision_maker' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/luis/Turtlebot-Project/src/decision_maker/${idir}'.  ${_report}")
    endif()
...
set(decision_maker_EXPORTED_TARGETS "decision_maker_generate_messages_cpp;decision_maker_generate_messages_eus;decision_maker_generate_messages_lisp;decision_maker_generate_messages_nodejs;decision_maker_generate_messages_py")
...
set(depends "geometry_msgs;roscpp;std_msgs;message_runtime;tf2_geometry_msgs;move_base_msgs;actionlib;actionlib_msgs;explore_lite;turtlebot_2dnav;tf")
...
set(pkg_cfg_extras "decision_maker-msg-extras.cmake")
