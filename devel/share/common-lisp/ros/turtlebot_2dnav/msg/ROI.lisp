...
(cl:defmethod cl:initialize-instance :after ((m <ROI>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ROI)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot_2dnav-msg:<ROI> is deprecated: use turtlebot_2dnav-msg:ROI instead.")))

(cl:ensure-generic-function 'Header-val :lambda-list '(m))
(cl:defmethod Header-val ((m <ROI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_2dnav-msg:Header-val is deprecated.  Use turtlebot_2dnav-msg:Header instead.")
  (Header m))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <ROI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_2dnav-msg:type-val is deprecated.  Use turtlebot_2dnav-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <ROI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_2dnav-msg:center-val is deprecated.  Use turtlebot_2dnav-msg:center instead.")
  (center m))

(cl:ensure-generic-function 'size_x-val :lambda-list '(m))
(cl:defmethod size_x-val ((m <ROI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_2dnav-msg:size_x-val is deprecated.  Use turtlebot_2dnav-msg:size_x instead.")
  (size_x m))

(cl:ensure-generic-function 'size_y-val :lambda-list '(m))
(cl:defmethod size_y-val ((m <ROI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_2dnav-msg:size_y-val is deprecated.  Use turtlebot_2dnav-msg:size_y instead.")
  (size_y m))
...
(cl:defmethod isnew-val ((m <ROI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_2dnav-msg:isnew-val is deprecated.  Use turtlebot_2dnav-msg:isnew instead.")
  (isnew m))
