...
if("TRUE" STREQUAL "TRUE")
  set(map_merger_SOURCE_PREFIX /home/luis/TurtleBot_Project/src/aau_multi_robot/map_merger)
  set(map_merger_DEVEL_PREFIX /home/luis/TurtleBot_Project/devel)
  ...
  set(map_merger_INSTALL_PREFIX /home/luis/TurtleBot_Project/install)
...
if(NOT "/home/luis/TurtleBot_Project/devel/include " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/map_merger/ " STREQUAL " ")
    set(_report "Check the website 'http://wiki.ros.org/map_merger/' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Peter Kohout <peter_kohout@gmx.at>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'map_merger' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'map_merger' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/luis/TurtleBot_Project/src/aau_multi_robot/map_merger/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT map_merger_NUM_DUMMY_TARGETS)
      set(map_merger_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::map_merger::wrapped-linker-option${map_merger_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR map_merger_NUM_DUMMY_TARGETS "${map_merger_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::map_merger::wrapped-linker-option${map_merger_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND map_merger_LIBRARIES "${interface_target_name}")
