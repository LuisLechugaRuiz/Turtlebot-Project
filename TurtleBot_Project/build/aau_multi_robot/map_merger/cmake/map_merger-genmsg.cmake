...
get_filename_component(_filename "/home/luis/TurtleBot_Project/src/aau_multi_robot/map_merger/srv/TransformPoint.srv" NAME_WE)
add_custom_target(_map_merger_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "map_merger" "/home/luis/TurtleBot_Project/src/aau_multi_robot/map_merger/srv/TransformPoint.srv" "adhoc_communication/MmPoint"
)

get_filename_component(_filename "/home/luis/TurtleBot_Project/src/aau_multi_robot/map_merger/srv/LogMaps.srv" NAME_WE)
add_custom_target(_map_merger_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "map_merger" "/home/luis/TurtleBot_Project/src/aau_multi_robot/map_merger/srv/LogMaps.srv" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/map_merger)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/map_merger\")")
  # install generated code
  install(
